...
2. What is an event?
Every interaction a user has with a site is known as an event; a click, moving the mouse, scrolling the page, pressing a key.

3. What is an event listener?
A function that waits for an event to happen and executes 

4. Why would we convert a NodeList into an Array?
So that array methods can be called on the items.

5. What is a component?
Made of several parts HTML, CSS or JS--broght together for reuse in a website or applicatoin.  Portions of site that will be repeated like -forms -navs -sidebars should leaverage components which are 
